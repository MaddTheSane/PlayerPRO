...
#else
#if defined(EMBEDPLUGS) && EMBEDPLUGS
MADErr mainMADI(MADFourChar order, FILE* AlienFileName, MADMusic *MadFile, MADInfoRec *info, MADDriverSettings *init)
#else
extern MADErr PPImpExpMain2(MADFourChar order, FILE * AlienFileName, MADMusic *MadFile, MADInfoRec *info, MADDriverSettings *init)
#endif
{
