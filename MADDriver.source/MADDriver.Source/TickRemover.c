...
void MADTickRemoverStart8( Channel *curVoice, long	*ASCBuffer1, long	*ASCBuffer2, MADDriverRec *intDriver)
{
			...
			curVoice->prevVol1 	!= curDoVol1)
	{
		...
		// Right Channel
		if( curVoice->prevVol0 != curDoVol0 && curVoice->prevPtr	== curVoice->begPtr && curVoice->begPtr != 0L)
		{
		...
		// Left Channel
		if( curVoice->prevVol1 != curDoVol1 && curVoice->prevPtr	== curVoice->begPtr && curVoice->begPtr != 0L)
		{
