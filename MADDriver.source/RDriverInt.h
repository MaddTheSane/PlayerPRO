...
PPEXPORT bool MADDirectSave(char *myPtr, MADDriverSettings *driverType, MADDriverRecPtr intDriver);
PPEXPORT bool MADDirectSaveAlways(char *myPtr, MADDriverSettings *driverType, MADDriverRecPtr intDriver);
