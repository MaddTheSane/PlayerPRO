...
void VisualFullScreen( void)
{
	...
	if( AHelpDlog != 0L) ActiveHelpActive = true;
	...
	CallVisualFonction( MADDriver, currentID, kVisualPluginSetWindowMessage, 0, 0L, 0);
...
BitMap		screenBits;
	...
	if( lSizeVH != 0)
	{
		...
		CallVisualFonction( MADDriver, currentID, kVisualPluginResizeMessage, 0, 0L, 0);
		CallVisualFonction( MADDriver, currentID, kVisualPluginSetWindowMessage, 0, 0L, 0);
...
void DoVisualNull()
{
	if( VisualDlog == 0L) return;
	
	CallVisualFonction( MADDriver, currentID, kVisualPluginRenderMessage, 0, 0L, 0);
...
void  UpdateVisualWindow(DialogPtr GetSelection)
{
	...
	CallVisualFonction( MADDriver, currentID, kVisualPluginUpdateMessage, 0, 0L, 0);
...
char			aStr[ 255];
	...
	HGetVol( 0L, &VisualPlug[ No].file.vRefNum, &VisualPlug[ No].file.parID);
...
void CreateVisualWindow( short ID)
{
	...
	VisualDlog = GetNewDialog( 185, 0L, GetDialogWindow( ToolsDlog));
	...
	CallVisualFonction( MADDriver, currentID, kVisualPluginInitializeMessage, 0, 0L, 0);
	CallVisualFonction( MADDriver, currentID, kVisualPluginEnableMessage, 0, 0L, 0);
...
//	CallVisualFonction( MADDriver, currentID, kVisualPluginResizeMessage, 0, 0L, 0);
	CallVisualFonction( MADDriver, currentID, kVisualPluginSetWindowMessage, 0, 0L, 0);
	CallVisualFonction( MADDriver, currentID, kVisualPluginShowWindowMessage, 0, 0L, 0);
	CallVisualFonction( MADDriver, currentID, kVisualPluginPlayMessage, 0, 0L, 0);
...
void CloseVisual(void)
{
	...
	if( VisualDlog != 0L)
	{
		...
		CallVisualFonction( MADDriver, currentID, kVisualPluginDisableMessage, 0, 0L, 0);
		CallVisualFonction( MADDriver, currentID, kVisualPluginHideWindowMessage, 0, 0L, 0);
		CallVisualFonction( MADDriver, currentID, kVisualPluginCleanupMessage, 0, 0L, 0);
		
		CallVisualMain( currentID, kPluginCleanupMessage);
		
		DisposDialog( VisualDlog);
...
Rect	caRect;
	...
	else CallVisualFonction( MADDriver, currentID, kVisualPluginEventMessage, 0, 0L, 0);
}

void DoKeyVisual( DialogPtr whichDialog)
{
	if( whichDialog == 0L) return;
