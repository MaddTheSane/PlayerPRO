...
resource 'DITL' (1002, purgeable) {
	{	/* array DITLarray: 11 elements */
		...
		StaticText {
			disabled,
			"Veuillez choisir un fichier son à ouvrir"
			" :"
		}
	}
};
...
resource 'DITL' (2000) {
	{	/* array DITLarray: 35 elements */
		...
		RadioButton {
			enabled,
			"Pilote ASC (Sound Chip Mac 68 K)"
		},
		/* [4] */
		{177, 170, 193, 223},
		StaticText {
...
resource 'DITL' (2001) {
	{	/* array DITLarray: 25 elements */
		...
		StaticText {
			disabled,
			"Tapez sur le clavier du Mac pour changer"
			" les options."
		},
		/* [9] */
		{224, 110, 242, 208},
		...
		CheckBox {
			enabled,
			"Canal MIDI -> Instr. & pistes"
		},
		/* [19] */
		{153, 111, 171, 328},
		CheckBox {
			enabled,
			"MIDI Vélocité -> Volume"
		},
		/* [20] */
		{173, 111, 191, 349},
		CheckBox {
			enabled,
			"Effets E & D au positionnement"
		},
		/* [21] */
		{244, 10, 260, 119},
		StaticText {
...
resource 'DITL' (2002) {
	{	/* array DITLarray: 15 elements */
		...
		RadioButton {
			enabled,
			"Charger aléatoirement"
		},
		/* [4] */
		{40, 8, 56, 208},
		StaticText {
			disabled,
			"Après avoir joué une musique:"
		},
		/* [5] */
		{0, 0, 35, 259},
		UserItem {
		...
		CheckBox {
			enabled,
			"Ouvrir la première musique après chargem"
			"ent "
		},
		/* [9] */
		{104, 0, 105, 352},
		...
		CheckBox {
			enabled,
			"Position de départ à l'arrêt de la musiq"
			"ue"
		},
		/* [12] */
		{209, 10, 227, 319},
		...
		CheckBox {
			enabled,
			"Jouer automatiquement une musique chargé"
			"e"
		},
		/* [14] */
		{109, 8, 125, 226},
		StaticText {
			disabled,
			"Options de la liste des musiques:"
		},
		/* [15] */
		{129, 10, 147, 325},
		CheckBox {
			enabled,
			"Charger la même liste au prochain démarr"
			"age"
		}
	}
};
...
resource 'DITL' (300, purgeable) {
	{	/* array DITLarray: 5 elements */
		...
		StaticText {
			disabled,
			"Sauvegarder “^0” avant la fermeture?"
		},
		/* [5] */
		{10, 10, 42, 42},
		Picture {
...
resource 'DITL' (2003) {
	{	/* array DITLarray: 4 elements */
		...
		StaticText {
			disabled,
			"Cliquer pour changer de couleur"
		},
		/* [4] */
		{30, 180, 57, 332},
		UserItem {
...
resource 'DITL' (761) {
	{	/* array DITLarray: 40 elements */
		...
		StaticText {
			enabled,
			"Double clic pour configurer les options"
		},
		/* [8] */
		{58, 133, 90, 165},
		UserItem {
...
resource 'DITL' (2004) {
	{	/* array DITLarray: 15 elements */
		...
		CheckBox {
			enabled,
			"Compression automatique MAD1 des pattern"
			"s "
		},
		/* [2] */
		{41, 302, 53, 341},
		...
		StaticText {
			disabled,
			"Compression automatique à la sauvegarde:"
		},
		/* [4] */
		{82, 0, 83, 352},
		Picture {
		...
		CheckBox {
			enabled,
			"Mêmes options au prochain chargement"
		},
		/* [6] */
		{128, 10, 146, 347},
		CheckBox {
			enabled,
			"Sauver les options dans les ressources d"
			"u fichier"
		},
		/* [7] */
		{87, 10, 103, 264},
		...
		CheckBox {
			enabled,
			"Utiliser les options des fichiers (si di"
			"sponibles)"
		},
		/* [9] */
		{170, 0, 171, 352},
		...
		CheckBox {
			enabled,
			"Ajouter l'extension aux noms des fichier"
			"s"
		},
		/* [11] */
		{180, 320, 194, 339},
		...
		CheckBox {
			enabled,
			"Utiliser l'accès direct à la mémoire vid"
			"éo"
		},
		/* [14] */
		{175, 10, 191, 307},
		StaticText {
			disabled,
			"Options oscilloscope & analyseur de spec"
			"tre:"
		},
		/* [15] */
		{222, 10, 238, 264},
...
resource 'DITL' (175) {
	{	/* array DITLarray: 8 elements */
		...
		StaticText {
			disabled,
			"Entrer votre code d'enregistrement & vot"
			"re nom:"
		},
		/* [8] */
		{73, -43, 94, 12},
...
resource 'DITL' (934) {
	{	/* array DITLarray: 3 elements */
		...
		StaticText {
			disabled,
			"^0% du temps machine est utilisé pour la"
			" création d'une musique et d'autres proc"
			"essus en tâche de fond."
		},
		/* [3] */
		{3, 4, 35, 36},
		Picture {
...
resource 'DITL' (3004, purgeable) {
	{	/* array DITLarray: 5 elements */
		...
		StaticText {
			disabled,
			"Sauver cette liste de musiques “^0” avan"
			"t la fermeture ?"
		},
		/* [5] */
		{10, 10, 42, 42},
...
resource 'DITL' (302) {
	{	/* array DITLarray: 3 elements */
		...
		StaticText {
			disabled,
			"Votre musique est maintenant plus petite"
			" de ^0 octets..."
		},
		/* [3] */
		{10, 10, 42, 42},
...
resource 'DITL' (2008) {
	{	/* array DITLarray: 16 elements */
		...
		CheckBox {
			enabled,
			"Afficher la longueur des notes"
		},
		/* [9] */
		{112, 29, 128, 105},
		StaticText {
...
//	$"270C 010C 0645 7272 6575 7270 0A"                   /* '....Erreurp¬ */
//};
...
resource 'MENU' (128) {
	...
	{	/* array: 19 elements */
		/* [1] */
		"Nouveau...", noIcon, "N", noMark, plain,
		/* [2] */
		"Ouvrir...", noIcon, "O", noMark, plain,
		/* [3] */
		"Sauver", noIcon, "S", noMark, plain,
		/* [4] */
		"Sauver sous...", noIcon, noKey, noMark, plain,
		/* [5] */
		...
		/* [8] */
		"Sauver la liste des musiques...", noIcon, noKey, noMark, plain,
		/* [9] */
		"Effacer la liste des musiques", noIcon, noKey, noMark, plain,
		/* [10] */
		"-", noIcon, noKey, noMark, plain,
		/* [11] */
		"Format d'impression...", noIcon, noKey, noMark, plain,
		/* [12] */
		"Imprimer...", noIcon, noKey, noMark, plain,
		/* [13] */
		"-", noIcon, noKey, noMark, plain,
		/* [14] */
		"Préférences...", noIcon, hierarchicalMenu, "»", plain,
		/* [15] */
		"Tableau de bord Son...", noIcon, noKey, noMark, plain,
		/* [16] */
		"Configurer Studio OMS ...", noIcon, noKey, noMark, plain,
		/* [17] */
		"Configurer MIDI OMS...", noIcon, noKey, noMark, plain,
		/* [18] */
		"-", noIcon, noKey, noMark, plain,
		/* [19] */
...
resource 'MENU' (133) {
	...
	{	/* array: 4 elements */
		/* [1] */
		"À propos de PlayerPRO...", noIcon, noKey, noMark, 32,
		/* [2] */
...
resource 'MENU' (140) {
	...
	{	/* array: 12 elements */
		/* [1] */
		"Éditeur digital", noIcon, noKey, noMark, plain,
		/* [2] */
		"Éditeur classique (cases)", noIcon, noKey, noMark, plain,
		/* [3] */
		"Éditeur classique (portées)", noIcon, noKey, noMark, plain,
		/* [4] */
		"Aperçu des formes d'ondes", noIcon, noKey, noMark, plain,
		/* [5] */
		"-", noIcon, noKey, noMark, plain,
		/* [6] */
		"Rechercher...", noIcon, "F", noMark, plain,
		/* [7] */
		"Rechercher la note courante", noIcon, "E", noMark, plain,
		/* [8] */
		"-", noIcon, noKey, noMark, plain,
		/* [9] */
		"Minimiser", noIcon, noKey, noMark, plain,
		/* [10] */
		"Convertir toutes les patterns à 64 ligne"
		"s", noIcon, noKey, noMark, plain,
		/* [11] */
		"-", noIcon, noKey, noMark, plain,
		/* [12] */
		"Informations générales", noIcon, noKey, noMark, plain
	}
};
...
resource 'MENU' (130) {
	...
	{	/* array: 8 elements */
		/* [1] */
		"Liste des instruments", noIcon, "L", noMark, plain,
		/* [2] */
		"-", noIcon, noKey, noMark, plain,
		/* [3] */
		"Nouveau...", noIcon, hierarchicalMenu, "ö", plain,
		/* [4] */
		"Importer...", noIcon, noKey, noMark, plain,
		/* [5] */
		"Exporter sous...", noIcon, noKey, noMark, plain,
		/* [6] */
		"Effacer", noIcon, noKey, noMark, plain,
		/* [7] */
		"-", noIcon, noKey, noMark, plain,
		/* [8] */
		"Sauver la liste des instruments...", noIcon, noKey, noMark, plain
	}
};
...
resource 'MENU' (131) {
	...
	{	/* array: 20 elements */
		/* [1] */
		"Aide en ligne", noIcon, noKey, noMark, plain,
		/* [2] */
		"-", noIcon, noKey, noMark, plain,
		/* [3] */
		"Pattern", noIcon, noKey, noMark, plain,
		/* [4] */
		"Digital", noIcon, noKey, noMark, plain,
		/* [5] */
		"Piste", noIcon, "T", noMark, plain,
		/* [6] */
		"Instrument ", noIcon, noKey, noMark, plain,
		/* [7] */
		"-", noIcon, noKey, noMark, plain,
		/* [8] */
		"Oscilloscope", noIcon, noKey, noMark, plain,
		/* [9] */
		"Analyseur de spectre", noIcon, noKey, noMark, plain,
		/* [10] */
		"-", noIcon, noKey, noMark, plain,
		/* [11] */
		"Outils", noIcon, noKey, noMark, plain,
		/* [12] */
		"Liste des musiques ", noIcon, "M", noMark, plain,
		/* [13] */
		"Adapteurs", noIcon, noKey, noMark, plain,
		/* [14] */
		"Piano", noIcon, "P", noMark, plain,
		/* [15] */
		"Mémoire", noIcon, noKey, noMark, plain,
		/* [16] */
		"-", noIcon, noKey, noMark, plain,
		/* [17] */
		"Plein écran", noIcon, noKey, noMark, plain,
		/* [18] */
		"Économiseur d'écran", noIcon, noKey, noMark, plain,
		/* [19] */
		"ScrollText ON", noIcon, noKey, noMark, plain,
		/* [20] */
		"3D Cube", noIcon, noKey, noMark, plain
	}
};
...
resource 'MENU' (200, "Prefs") {
	...
	{	/* array: 10 elements */
		...
		/* [2] */
		"Piano - Entrée", noIcon, noKey, noMark, plain,
		/* [3] */
		"Liste des musiques", noIcon, noKey, noMark, plain,
		/* [4] */
		"Couleur", noIcon, noKey, noMark, plain,
		/* [5] */
		...
		/* [9] */
		"Classical Editor", noIcon, noKey, noMark, plain,
		/* [10] */
...
resource 'MENU' (135) {
	...
	{	/* array: 16 elements */
		...
		/* [9] */
		"8-NOT USED", noIcon, noKey, noMark, plain,
		/* [10] */
...
resource 'MENU' (136) {
	...
	{	/* array: 3 elements */
		/* [1] */
		"Sélection->Boucle", noIcon, noKey, noMark, plain,
		/* [2] */
		"Boucle->Sélection", noIcon, noKey, noMark, plain,
		/* [3] */
		"Effacer", noIcon, noKey, noMark, plain
	}
};
...
resource 'MENU' (137) {
	...
	{	/* array: 32 elements */
		/* [1] */
		"Piste 1", noIcon, noKey, noMark, plain,
		/* [2] */
		"Piste 2", noIcon, noKey, noMark, plain,
		/* [3] */
		"Piste 3", noIcon, noKey, noMark, plain,
		/* [4] */
		"Piste 4", noIcon, noKey, noMark, plain,
		/* [5] */
		"Piste 5", noIcon, noKey, noMark, plain,
		/* [6] */
		"Piste 6", noIcon, noKey, noMark, plain,
		/* [7] */
		"Piste 7", noIcon, noKey, noMark, plain,
		/* [8] */
		"Piste 8", noIcon, noKey, noMark, plain,
		/* [9] */
		"Piste 9", noIcon, noKey, noMark, plain,
		/* [10] */
		"Piste 10", noIcon, noKey, noMark, plain,
		/* [11] */
		"Piste 11", noIcon, noKey, noMark, plain,
		/* [12] */
		"Piste 12", noIcon, noKey, noMark, plain,
		/* [13] */
		"Piste 13", noIcon, noKey, noMark, plain,
		/* [14] */
		"Piste 14", noIcon, noKey, noMark, plain,
		/* [15] */
		"Piste 15", noIcon, noKey, noMark, plain,
		/* [16] */
		"Piste 16", noIcon, noKey, noMark, plain,
		/* [17] */
		"Piste 17", noIcon, noKey, noMark, plain,
		/* [18] */
		"Piste 18", noIcon, noKey, noMark, plain,
		/* [19] */
		"Piste 19", noIcon, noKey, noMark, plain,
		/* [20] */
		"Piste 20", noIcon, noKey, noMark, plain,
		/* [21] */
		"Piste 21", noIcon, noKey, noMark, plain,
		/* [22] */
		"Piste 22", noIcon, noKey, noMark, plain,
		/* [23] */
		"Piste 23", noIcon, noKey, noMark, plain,
		/* [24] */
		"Piste 24", noIcon, noKey, noMark, plain,
		/* [25] */
		"Piste 25", noIcon, noKey, noMark, plain,
		/* [26] */
		"Piste 26", noIcon, noKey, noMark, plain,
		/* [27] */
		"Piste 27", noIcon, noKey, noMark, plain,
		/* [28] */
		"Piste 28", noIcon, noKey, noMark, plain,
		/* [29] */
		"Piste 29", noIcon, noKey, noMark, plain,
		/* [30] */
		"Piste 30", noIcon, noKey, noMark, plain,
		/* [31] */
		"Piste 31", noIcon, noKey, noMark, plain,
		/* [32] */
		"Piste 32", noIcon, noKey, noMark, plain
	}
};
...
resource 'MENU' (139) {
	...
	{	/* array: 2 elements */
		/* [1] */
		"Son AIFF", noIcon, noKey, noMark, plain,
		/* [2] */
		"-", noIcon, noKey, noMark, plain
	}
};
...
resource 'MENU' (143) {
	...
	{	/* array: 3 elements */
		...
		/* [2] */
		"F#4 - Très bonne", noIcon, noKey, noMark, plain,
		/* [3] */
...
resource 'MENU' (145) {
	...
	{	/* array: 8 elements */
		/* [1] */
		"Liste des partitions", noIcon, noKey, noMark, plain,
		/* [2] */
		"Liste des patterns ", noIcon, noKey, noMark, plain,
		/* [3] */
		"-", noIcon, noKey, noMark, plain,
		/* [4] */
		"Créer une nouvelle pattern", noIcon, noKey, noMark, plain,
		/* [5] */
		"Ouvrir...", noIcon, noKey, noMark, plain,
		/* [6] */
		"Sauver sous...", noIcon, noKey, noMark, plain,
		/* [7] */
		"Purger", noIcon, noKey, noMark, plain,
		/* [8] */
		"Effacer", noIcon, noKey, noMark, plain
	}
};
...
resource 'MENU' (147) {
	...
	{	/* array: 2 elements */
		/* [1] */
		"SANS", noIcon, noKey, noMark, plain,
		/* [2] */
...
resource 'MENU' (150) {
	...
	{	/* array: 3 elements */
		...
		/* [3] */
		"Entrée audio ", noIcon, noKey, noMark, plain
	}
};
...
resource 'MENU' (152) {
	...
	{	/* array: 17 elements */
		...
		/* [2] */
		"Percussion chromatique", noIcon, noKey, noMark, plain,
		/* [3] */
		"Orgue", noIcon, noKey, noMark, plain,
		/* [4] */
		"Guitare", noIcon, noKey, noMark, plain,
		/* [5] */
		"Basse", noIcon, noKey, noMark, plain,
		/* [6] */
		"Instruments à cordes", noIcon, noKey, noMark, plain,
		/* [7] */
		"Ensembles", noIcon, noKey, noMark, plain,
		/* [8] */
		"Cuivres", noIcon, noKey, noMark, plain,
		/* [9] */
		"Instruments à anche", noIcon, noKey, noMark, plain,
		/* [10] */
		"Tuyau d'orgue", noIcon, noKey, noMark, plain,
		/* [11] */
		"Synthé principal", noIcon, noKey, noMark, plain,
		/* [12] */
		"Synthé", noIcon, noKey, noMark, plain,
		/* [13] */
		"Effets synthé.", noIcon, noKey, noMark, plain,
		/* [14] */
		"Exotique", noIcon, noKey, noMark, plain,
		/* [15] */
		"Percussion", noIcon, noKey, noMark, plain,
		/* [16] */
		"Effets de sons", noIcon, noKey, noMark, plain,
		/* [17] */
		"Batterie", noIcon, noKey, noMark, plain
	}
};
...
resource 'MENU' (154) {
	...
	{	/* array: 3 elements */
		/* [1] */
		"Silence/Générateur de tonalité", noIcon, noKey, noMark, plain,
		/* [2] */
		"Enregistrement (Entrée audio)", noIcon, noKey, noMark, plain,
		/* [3] */
...
resource 'MENU' (160) {
	...
	{	/* array: 2 elements */
		/* [1] */
		"linéaire", noIcon, noKey, noMark, plain,
		/* [2] */
...
resource 'MENU' (162) {
	...
	{	/* array: 3 elements */
		...
		"Boucle->sélection", noIcon, noKey, noMark, plain,
		/* [3] */
		"Définir le point de sustain", noIcon, noKey, noMark, plain
	}
};
...
resource 'MENU' (164) {
	...
	{	/* array: 15 elements */
		...
		"-", noIcon, noKey, noMark, plain,
		/* [9] */
		"Japan", noIcon, noKey, noMark, plain,
		/* [10] */
		"-", noIcon, noKey, noMark, plain,
		/* [11] */
...
resource 'MENU' (168) {
	...
	{	/* array: 2 elements */
		/* [1] */
		"Empilé", noIcon, noKey, noMark, plain,
		/* [2] */
		"Séparé", noIcon, noKey, noMark, plain
	}
};
...
resource 'MENU' (500) {
	...
	{	/* array: 6 elements */
		/* [1] */
		"Tous les formats disponibles", noIcon, noKey, noMark, plain,
		/* [2] */
		"Tous les fichiers lisibles", noIcon, noKey, noMark, plain,
		/* [3] */
		"Tous les fichiers", noIcon, noKey, noMark, plain,
		/* [4] */
		"-", noIcon, noKey, noMark, plain,
		/* [5] */
...
resource 'STR#' (128, "Errors") {
	{	/* array StringArray: 91 elements */
		/* [1] */
		"Player PRO ne peut que lire les sons de "
		"11Khz ou 22Khz.",
		/* [2] */
		"Il n'y a pas assez de mémoire pour ce so"
		"n. Allouer plus de mémoire à Player PRO "
		"en utilisant “Lire les informations” du "
		"Finder. ",
		/* [3] */
		"Ce programme requiert un adressage 32 bi"
		"ts. Utiliser le tableau de bord Mémoire "
		"pour définir le mode système à 32 bits e"
		"t redémarrer.",
		/* [4] */
		"Aucun sons/musique n'a été trouvé dans c"
		"e fichier. Tester le fichier.",
		/* [5] */
		"Une erreur de fichier est survenue. Il n"
		"'y a probablement pas assez de mémoire.",
		/* [6] */
		"Le système 7.0 est requis par Player PRO"
		".",
		/* [7] */
		"Ce son utilise un format de compression "
		"qui ne peut pas être lu par Player PRO. "
		...
		"ert.",
		/* [9] */
		"Mémoire dangereusement basse.  Allouer p"
		"lus de mémoire à Player PRO en utilisant"
		...
		"acintoshs série AV.",
		/* [12] */
		"Désolé, mais vous êtes un utilisateur NO"
		"N ENREGISTRE ! Voir “Enregistrement” dan"
		"s le menu Pomme pour savoir comment accé"
		"der à toutes les fonctions.",
		/* [13] */
		"Pour faire cela, vous devez sélectionner"
		" un instrument dans la fenêtre “Liste in"
		"struments”.",
		/* [14] */
		"Voulez-vous vraiment remplacer cet instr"
		"ument?",
		/* [15] */
		"Ce fichier MOD est dépassé. Voulez-vous "
		"le mettre à jour ?",
		/* [16] */
		...
		"A. ROSSET.",
		/* [17] */
		"Votre Macintosh ne peut pas jouer en sté"
		"réo. Achetez un autre Macintosh!",
		/* [18] */
		"Où est le Apple Sound Chip (ASC)? Quel e"
		"st cet ordinateur ?",
		/* [19] */
		"Désolé, mais vous ne possédez pas de mic"
		"rophone.",
		/* [20] */
		"La boucle de l'instrument est incorrecte"
		". Veuillez la régler.",
		/* [21] */
		"Etes-vous sûr de vouloir effacer cet ins"
		"trument?",
		/* [22] */
		"Désolé, mais vous ne pouvez pas utiliser"
		" ce pilote sans le Apple Sound Chip.",
		/* [23] */
		"Vous devez être en mode 256 couleurs et "
		"avoir une résolution de 640 x 480 pour u"
		"tiliser cette fonction.",
		/* [24] */
		"Désolé, mais ce son est trop large. Les "
		"instruments doivent être plus petits que"
		" 128 Ko.",
		/* [25] */
		...
		" et Option.)",
		/* [26] */
		"Désolé, mais cette réponse est invalide."
		...
		" pour tourner.",
		/* [28] */
		"Désolé, mais la longueur de la partition"
		" doit être comprise entre 1 et 128.",
		/* [29] */
		"Désolé, mais le code d'enregistrement es"
		"t incorrect.",
		/* [30] */
		"Veuillez entrer votre nom.",
		/* [31] */
		"Ce programme a déjà été enregistré.",
		/* [32] */
		"40 minutes est déjà long pour se servir "
		"d'un programme NON ENREGISTRE, n'est-ce-"
		"pas ? Veuillez enregistrer votre copie d"
		"e Player PRO!",
		/* [33] */
		"Désolé, mais Player PRO requiert les App"
		"leEvents.",
		/* [34] */
		"Désolé, mais il n'y a rien à imprimer da"
		"ns cette fenêtre.",
		/* [35] */
		"Ce fichier MIDI est inconnu. Il ne sembl"
		"e pas être un fichier SMF (MThd).",
		/* [36] */
		"Dans votre liste de patterns, le nombre "
		"de pattern DOIT apparaître au minimum un"
		"e fois!",
		/* [37] */
		"Etes-vous sûr de vouloir remplacer la pa"
		"rtition courante avec cette partition de"
		" fichier MIDI ?",
		/* [38] */
		"Désolé, mais rien n'est sélectionné.",
		/* [39] */
		"Ce fichier MIDI n'a aucun sample. Des sa"
		"mple sont requis si vous voulez écouter "
		"quelque chose !",
		/* [40] */
		"Désolé, mais les modules de filtres “Plu"
		"g-In” retournent une erreur. Veuillez vo"
		"us référer à la documentation.",
		/* [41] */
		"Désolé, mais Player PRO n'est PAS ENREGI"
		"STREE, et votre période d'essai de 15 jo"
		"urs est arrivée à terme. Vous devez acqu"
		"érir ce programme ou l'effacer !",
		/* [42] */
		...
		"Valeur invalide !",
		/* [44] */
		"Ouverture de ce fichier impossible.\nErre"
		"ur de type de fichier.\nErreur de filtre "
		"d'importation.",
		/* [45] */
		"Aucune méthode d'importation n'est dispo"
		"nible pour ouvrir ce fichier.",
		/* [46] */
		"Etes-vous sûr de vouloir effacer les not"
		"es de cette piste et de cette pattern?",
		/* [47] */
		"ATTENTION - C'est une beta version de ce"
		" filtre d'importation !",
		/* [48] */
		"Etes-vous sûr de vouloir purger cette pa"
		"ttern?",
		/* [49] */
		"Cette pattern ne peut pas être effacée. "
		"Votre fichier musique DOIT avoir au mini"
		"mum 1 pattern.",
		/* [50] */
		"Etes-vous sûr de vouloir effacer cette p"
		"attern?",
		/* [51] */
		"Voulez-vous remplacer la pattern sélecti"
		"onnée ou le charger dans une nouvelle pa"
		"ttern ?",
		/* [52] */
		"Cette version de PlayerPRO supporte une "
		"taille de pattern comprise entre 1 et 99"
		"9. Veuillez la changer !",
		/* [53] */
		"Voulez-vous vraiment changer l'amplitude"
		" de ce son ?",
		/* [54] */
		"Erreur de pilote d'impression...",
		/* [55] */
		"Utiliser le programme PtMid pour convert"
		...
		/* [58] */
		"La valeur facteur MIDI doit être compris"
		"e entre 0% et 500% de la valeur vélocité"
		".",
		/* [59] */
		"Erreur dans la valeur 'argument'. Elle d"
		"oit être en héxadecimal entre 0 et FF.",
		/* [60] */
		"Corriger le type & créateur de ce fichie"
		"r avant l'ouverture ?",
		/* [61] */
		"Ce périphérique SoundInPut ne supporte p"
		"as la zone de dialogue  options.",
		/* [62] */
		"Fichier introuvable !\nCette musique n'a "
		"pas été trouvée sur votre disque dur.",
		/* [63] */
		"Pas assez de mémoire pour cette opératio"
		"n. Allouez plus de mémoire à PlayerPRO.",
		/* [64] */
		"Le nom “^2” est déjà donné à un autre fi"
		"chier. Veuillez utiliser un nom différen"
		"t.",
		/* [65] */
		"Donnez un nom à ce son, si vous voulez c"
		"réer un fichier !",
		/* [66] */
		"Désolé, mais la fréquence (c2spd) doit ê"
		"tre comprise entre  1 Hz et 50 Khz.",
		/* [67] */
		"ERREUR DE FILTRE: Cette fonction n'est p"
		"as supportée par ce filtre. (orderNotImp"
		"lemented)",
		/* [68] */
		"ERREUR DE FILTRE: Pas assez de mémoire p"
		"our cette opération. Allouez plus de mém"
		"oire à PlayerPRO. (needMoreMemory)",
		/* [69] */
		"ERREUR DE FILTRE: Ce format de fichier n"
		"'est pas supporté par ce filtre. (fileNo"
		...
		"hier.\n(cannotFindPlug)",
		/* [72] */
		"Vous ne possédez pas l'extension 'QuickT"
		"ime™ Musical Instruments'. Cette fonctio"
		"n n'est pas disponible.",
		/* [73] */
		"Erreur: PlayerPRO ne peut pas ouvrir les"
		" ressources de 'Help PP'.",
		/* [74] */
		"Erreur: Périphérique d'entrée introuvabl"
		"e.",
		/* [75] */
		"Erreur d'écriture: volume protégé contre"
		" l'écriture.",
		/* [76] */
		"Désolé, mais la note réelle doit être co"
		"mpris entre -96 et 96.",
		/* [77] */
		"Désolé, mais le volume doit être compris"
		" entre 0 et 64.",
		/* [78] */
		"Désolé, mais le Volume Fade doit être co"
		"mpris entre 0 et 32767.",
		/* [79] */
		"Désolé, le maximum de points pour l'enve"
		"loppe de volume est 12.",
		/* [80] */
		"Erreur dans la valeur 'volume'. Elle doi"
		"t être en héxadecimal comprise entre 0 e"
		"t FF.",
		/* [81] */
		"Désolé, mais vous êtes un utilisateur no"
		"n enregistré ! Vous pouvez seulement ouv"
		"rir des fichiers musiques : MOD et MAD. "
		"Voir “Enregistrement” dans le menu Pomme"
		" comment obtenir le plein accès à toutes"
		" les fonctions.",
		/* [82] */
		"Vous avez désactivé \"Enregistrement Pian"
		"o\". Voir la fenêtre Piano.",
		/* [83] */
		"Erreur d'écriture. L'écriture de ce fich"
		"ier sur ce disque dur est impossible.",
		/* [84] */
		"Veuillez saisir le nom de votre pays.",
		/* [85] */
		"Veuillez sélectionner le distributeur, e"
		"n cliquant sur le menu pop-up.",
		/* [86] */
		"ERREUR DE FILTRE: PlayerPRO ne trouve pa"
		"s le filtre requis pour cette opération."
		"\n(cannotFindPlug)",
		/* [87] */
		"Votre fichier 'PlayerPRO Pref' est corro"
		"mpu. Il va être effacé!",
		/* [88] */
		"ATTENTION - Cette fonction est irréversi"
		"ble. Cette fonction efface toutes les do"
		"nnées inutilisées de cette musique. Cont"
		"inuer ?",
		/* [89] */
		"Je suis désolé, cette fonction requiert "
		"l'extension Drag Manager. Elle est dispo"
		"nible sur vos disques Système.",
		/* [90] */
		"PlayerPRO a un problème pour identifier "
