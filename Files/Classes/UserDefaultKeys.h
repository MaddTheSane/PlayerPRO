...
extern NSString *const PPPreferencesSet;
extern NSString *const PPAutoCreator;
extern NSString *const PPStartNumber;
extern NSString *const PPPianoKeys;
extern NSString *const PPLoopType;
extern NSString *const PPVolumeLevel;

//Windows
extern NSString *const PPWindowName1;
extern NSString *const PPWindowName2;
extern NSString *const PPWindowName3;
...
extern NSString *const PPDEMouseClickPref;
