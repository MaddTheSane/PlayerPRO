...
#define kPlayMusicID			'PLAY'	//
#define kStopMusicID			'STOP'	//

#define kSetSpeedID				'Sped'
#define kSetVolumeID			'Volu'
#define kSetPitchID				'Pitc'

#define kGotoPatternID			'GPat'
#define kGotoPositionID			'GPos'
#define kGotoPercentID			'GPer'
...
pascal OSErr  AEErreur( const AppleEvent *theAppleEvent, AppleEvent *reply, long refcon)
{
		...
		PSN.lowLongOfPSN != playerPROPSN.lowLongOfPSN)
	{
		...
		myNotification.nmStr	= 0L;				//display alert box
